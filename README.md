...
الخرائط الحالية مبنية على **Flutter Map** مع طبقات OpenStreetMap، مع إبقاء البنية قابلة لنقل مصدر الخرائط إلى مزود تجاري أو بنية مستضافة مخصصة عند الحاجة إلى SLA وحجم تشغيل حكومي مرتفع. لا توجد مفاتيح Google Maps أو أسرار خرائط داخل التطبيق.

الإشعارات الحالية تعتمد على بيانات الإشعارات داخل Supabase وRealtime أثناء تشغيل التطبيق. قبل الإطلاق النهائي يجب إضافة واختبار قناة إشعارات نظامية (OS push) على أجهزة حقيقية إذا كان مطلوباً وصول التنبيهات والتطبيق مغلقاً.
